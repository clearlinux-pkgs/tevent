...
%prep
%setup -q -n tevent-0.13.0
cd %{_builddir}/tevent-0.13.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666716471
...
/usr/lib64/tevent/libpytalloc-util.cpython-311-x86-64-linux-gnu-tevent.so
